...
const expectedArchiveHash = (await Bun.file("third-party/sources.sha256").text())
  .split("\n").find((line) => line.endsWith("  webkit-5488984d-source.tar.gz"))?.split(" ")[0]
...
const documents: [string, string, "header"?][] = [
  ["Bun 1.3.14 — upstream runtime and embedded-component notice", raw("oven-sh/bun", bunRef, "LICENSE.md")],
  ["Bun uWebSockets/uSockets", raw("oven-sh/bun", bunRef, "packages/bun-uws/LICENSE")],
  ["Bun clap", raw("oven-sh/bun", bunRef, "src/clap/LICENSE")],
  ["Bun uucode", raw("oven-sh/bun", bunRef, "src/unicode/uucode_lib/LICENSE.md")],
  ...
  ["BoringSSL", raw("oven-sh/boringssl", "0c5fce43b7ed5eb6001487ee48ac65766f5ddcd1", "LICENSE")],
  ["Brotli 1.1.0", raw("google/brotli", "v1.1.0", "LICENSE")],
  ["c-ares", raw("c-ares/c-ares", "3ac47ee46edd8ea40370222f91613fc16c434853", "LICENSE.md")],
  ...
  ["lol-html", raw("cloudflare/lol-html", "77127cd2b8545998756e8d64e36ee2313c4bb312", "LICENSE")],
  ...
  ["mimalloc", raw("oven-sh/mimalloc", "f15aecb94fc8096008bf87b90c53ed682026914a", "LICENSE")],
  ["picohttpparser", raw("h2o/picohttpparser", "066d2b1e9ab820703db0837a7255d92d30f0c9f5", "picohttpparser.h"), "header"],
  ["TinyCC (LGPL 2.1)", raw("oven-sh/tinycc", "12882eee073cfe5c7621bcfadf679e1372d4537b", "COPYING")],
